...
class CardsData {
    /**
     * KARTU KESEMPATAN (CHANCE)
     * Komposisi:
     * - 30% Rugi (6 Kartu)
     * - 30% Untung (6 Kartu)
     * - 30% Gacha / Taruhan (6 Kartu)
     * - 10% Kartu Sakti / Bebas Penjara & Bebas Pajak (2 Kartu)
     */
    public const CHANCE_CARDS = [
        // ==========================================
        // 1. 30% RUGI / PENALTI (6 KARTU)
        // ==========================================
        [
            'id' => 'c_loss_1',
        ...
        // ==========================================
        // 3. 30% GACHA / HIGH STAKES GAMBLE (6 KARTU)
        // ==========================================
        [
            'id' => 'c_gacha_1',
        ...
        // ==========================================
        // 4. 10% KARTU SAKTI SINGLE-USE (2 KARTU)
        // ==========================================
        [
            'id' => 'c_special_jail',
    ...
    /**
     * KARTU DANA UMUM (COMMUNITY CHEST)
     * Komposisi:
     * - 30% Rugi (6 Kartu)
     * - 30% Untung (6 Kartu)
     * - 30% Gacha / Taruhan (6 Kartu)
